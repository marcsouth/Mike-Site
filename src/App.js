...
<div className="landingpage w-screen h-screen bg-gradient-to-b from-transparent to-black">

  <div className="flex justify-center items-center flex-col text-center p-4">

    <h1 className='text-lime-500 text-7xl mt-40 mb-10 font-extrabold  p-4 flex drop-shadow-md'>MIKE CREPON FITNESS</h1>
